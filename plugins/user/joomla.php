...
class plgUserJoomla extends JPlugin
{
	...
	function &_getUser($user, $options = array())
	{
		...
		if($autoregister)
		{
			//send mail infrom Admin when user auto registrator
            ...
            $message = JTEXT::_('BODY_EMAIL_WITH_FIRST_TIME_RIGISTRATION');
            JUtility::sendMail( $instance->email, $instance->email, $MailAdmin, $subject, $message, 1 );   
			$_SESSION['email_autoregister'] = 1; 
