<?php
// $Header: /cvsroot/html2ps/css.list-style.inc.php,v 1.6 2006/09/07 18:38:14 Konstantin Exp $

require_once(HTML2PS_DIR.DIRECTORY_SEPARATOR.'value.list-style.class.php');
