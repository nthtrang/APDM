<?php
// $Header: /cvsroot/html2ps/box.table.cell.php,v 1.38 2006/09/07 18:38:12 Konstantin Exp $
...
class TableCellBox extends GenericContainerBox {
  ...
  function &create(&$root, &$pipeline) {
    ...
    if ($border_handler->is_default($box->getCSSProperty(CSS_BORDER))) {
      $box->setCSSProperty(CSS_BORDER, $css_state->getProperty(CSS_HTML2PS_TABLE_BORDER));
    };
