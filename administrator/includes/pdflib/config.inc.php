<?php
// $Header: /cvsroot/html2ps/config.inc.php,v 1.30 2006/10/06 20:10:52 Konstantin Exp $
...
define('CACHE_DIR', HTML2PS_DIR.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR);
define('OUTPUT_FILE_DIRECTORY', DIRECTORY_SEPARATOR.'temp'.DIRECTORY_SEPARATOR); ///////////////////// save file dir
define('FPDF_PATH', HTML2PS_DIR.DIRECTORY_SEPARATOR.'fpdf'.DIRECTORY_SEPARATOR);
...
define('WRITER_TEMPDIR', HTML2PS_DIR.DIRECTORY_SEPARATOR.'temp'.DIRECTORY_SEPARATOR);
...
define('HTML2PS_CONNECTION_TIMEOUT', 100);
