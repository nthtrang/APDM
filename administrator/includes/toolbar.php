...
class JToolBarHelper
{
	...
	*/
	function preferences($component, $height='150', $width='570', $alt = 'Preferences', $path = '')
	{
        ...
        function titleEco($title, $icon = 'generic.png')
	{
		global $mainframe;
        ...
        function addPns($alt = 'New',$eco_id=0)
	{
        ...
        function addPnsInit($alt = 'New',$eco_id=0)
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
		$bar->appendButton( 'Popup', 'new', $alt, "index.php?option=com_apdmpns&task=get_list_pns_eco_init&tmpl=component&cid[]=$eco_id", 850,500 );
	}        
        function newPns($alt = 'New',$eco_id=0)
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
		$bar->appendButton( 'Standard', 'new', $alt, "index.php?option=com_apdmpns&task=add&cid[]=$eco_id", false,false );
	}        
        ...
        function addPnsRev($alt = 'New',$id=0)
	{
        ...
        function addEcoRoutes($alt = 'New',$id=0)
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
        ...
        function addQuoRoutes($alt = 'New',$id=0)
	{
        ...
        function popUpCompleteStepWo($alt = 'New', $task = 'save_complete_step',$step='wo_step1',$id=0,$so_id=0,$width=750,$height=400,$icon='forward')
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
		$bar->appendButton( 'Popup', $icon, $alt, "index.php?option=com_apdmpns&task=".$task."&step=".$step."&tmpl=component&id=".$id."&so_id=".$so_id."", $width,$height);
	} 
	function deleteEcoRoutes($msg = '', $task = 'remove_routes', $alt = 'Delete')
	{
        ...
        function addPnsPos($alt = 'New',$id=0)
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
        ...
        function addPos($alt = 'New',$id=0)
	{
        ...
        function addNewito($alt = 'New',$id=0)
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
		$bar->appendButton( 'Popup', 'new', $alt, "index.php?option=com_apdmpns&task=add_stoi&tmpl=component", 600,300 );
	}     
        function addNeweto($alt = 'New',$id=0)
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
        ...
        function addLocation($alt = 'New',$id=0)
	{
        ...
        function addWoSo($alt = 'New',$so_id=0)
	{
		$bar = & JToolBar::getInstance('toolbar');
		// Add an upload button
