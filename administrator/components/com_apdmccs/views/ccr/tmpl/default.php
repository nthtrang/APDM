...
<?php
	JToolBarHelper::title( JText::_( 'APDM Recyle Bin' ), 'trash.png' );		
	JToolBarHelper::deleteList('Are you sure to delete it?', 'delete');
	JToolBarHelper::customX('restore', 'trash', '', 'Restore', true);
	JToolBarHelper::cancel( 'cancel_trash', 'Close' );
...
<form action="index.php?option=com_apdmccs" method="post" name="adminForm">
	...
	<input type="hidden" name="task" value="trash" />
