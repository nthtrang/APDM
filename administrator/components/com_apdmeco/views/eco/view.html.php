...
class ecoVieweco extends JView
{
	function display($tpl = null)
	{
		...
		$status[] = JHTML::_('select.option',  'Pending', JText::_('Pending') );
		$status[] = JHTML::_('select.option',  'Released', JText::_('Released'));	
		$status[] = JHTML::_('select.option',  'Reject', JText::_('Reject') );		
