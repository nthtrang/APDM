...
/*--------------------- Phuc Build More Function -----------------------------------------------------------------------------*/
/*
    Function get list role to asign for user by ajax
*/
    function list_ajax_role(){
        $db =& JFactory::getDBO();
        $query = "SELECT role_id, role_name FROM admp_role ORDER BY role_name ";
        $db->setQuery($query);
