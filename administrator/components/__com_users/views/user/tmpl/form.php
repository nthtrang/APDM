...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton) {
		...
		if (trim(form.first_name.value) == "") {
			...
			alert( "<?php echo JText::_( 'You must provide a last name.', true ); ?>" );
		...
		<legend><?php echo JText::_( 'User Details' ); ?></legend>
			<table class="admintable" cellspacing="1">
				<tr>
					...
					<td>
						<input type="text" name="first_name" id="first_name" class="inputbox" size="40" value="<?php echo $this->user->get('name'); ?>" />
					</td>
				</tr>
				<tr>
					<td width="150" class="key">
					...
					<td>
						<input type="text" name="last_name" id="last_name" class="inputbox" size="40" value="<?php echo $this->user->get('name'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
				...
				<?php } if ($this->me->authorize( 'com_users', 'email_events' ) && ($me->get('gid') > 24 )) { ?>
				<tr>
					<td class="key">
