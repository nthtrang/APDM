		...
		<legend><?php echo JText::_( 'User Details' ); ?></legend>
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<td>
						<input type="text" name="username" id="username" class="inputbox" size="40" value="<?php echo $this->user[0]->username; ?>" autocomplete="off"  />
					</td>
				</tr>
				<?php if (trim($this->user[0]->password) !='') { ?>
