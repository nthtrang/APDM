...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1366 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td width=0 >PART NUMBER MANAGEMENT</td>
  <td width=546 >&nbsp;</td>
  <td width=546 >&nbsp;</td>
  <td width=546 >&nbsp;</td>
  <td></td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td  width=546 ><?php echo $username; ?></td>
  <td  width=546 >&nbsp;</td>
  <td  width=546 >&nbsp;</td>
  <td  width=546 >&nbsp;</td>
  <td class=xl24></td>
 ...
 <tr height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  <td class=xl30 width=546 style='width:176pt'>PartNo</td>
  <td class=xl31 width=546 style='width:70pt'>Rev</td>
  <td class=xl31 width=546 style='width:100pt'>ECO</td>
  <td class=xl31 width=546 style='width:200pt'>Description</td>
   <td class=xl30 width=546 style='width:176pt'>Parent</td>
   <td class=xl30 width=546 style='width:100pt'>Type</td>
   <td class=xl30 width=546 style='width:176pt'>Mfg</td>
   <td class=xl30 width=546 style='width:176pt'>Supplier</td>
   <td class=xl30 width=546 style='width:176pt'>Vendor</td>
  <td class=xl32 width=546 style='width:73pt'>Status</td>
 </tr>
 <?php  //for content  
 $i=1;  
 foreach($rows as $row){ 
	 $arr_parent = CPNsController::GetArrPartNumberParent($row->pns_id);
	 $arr_mf = CPNsController::GetArrInfo($row->pns_id, 4);
	 $arr_vendor = CPNsController::GetArrInfo($row->pns_id, 2);
	 $arr_supplier = CPNsController::GetArrInfo($row->pns_id, 3);
 ?>
 <tr height=34 style='height:25.5pt'>
  <td height=34 style='height:25.5pt'></td>
  <td class=xl33 width=546 style='width:69pt'><?php echo $i?>&nbsp;</td>
  <td class=xl33 width=546 style='width:176pt'><?php echo $row->ccs_code.'-'.$row->pns_code?></td>
  <td class=xl34 width=546 style='width:70pt' x:str="<?php echo $row->pns_revision?>"><?php echo $row->pns_revision?></td>
  <td class=xl34 width=546 style='width:100pt' x:str="<?php echo CPNsController::GetECO($row->eco_id);?>"><?php echo CPNsController::GetECO($row->eco_id);?></td>
  <td class=xl34 width=546 style='width:200pt' x:str="<?php echo $row->pns_description;?>"><?php echo $row->pns_description;?></td>
  <td class=xl34 width=546 style='width:176pt' ><?php echo implode('.<br />', $arr_parent)?></td>
  <td class=xl34 width=546 style='width:100pt' x:str="<?php echo $row->pns_type;?>"><?php echo $row->pns_type;?></td>
  <td class=xl34 width=546 style='width:176pt'><?php echo implode('.<br />', $arr_mf)?></td>
  <td class=xl34 width=546 style='width:176pt' ><?php echo implode('.<br />', $arr_supplier)?></td>
  <td class=xl34 width=546 style='width:176pt'><?php echo implode('.<br />', $arr_vendor)?></td>
  
  <td class=xl35 width=546 style='width:73pt' x:str="<?php echo ($row->eco_status)? 'Inactivate' : 'Activate'?>"><?php echo ($row->eco_status)? 'Inactivate' : 'Activate'?></td>
 </tr>
