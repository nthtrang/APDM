...
<input type="button" name="where_used" value="<?php echo JText::_('List PNs')?>"/>
				...
				<tr>
					...
					<td>
					<input type="text" value="<?php echo CPNsController::GetECO($this->row->eco_id); ?>" name="eco_name" id="eco_name" readonly="readonly" />
	...
	<div class="col width-40">
		...
		<legend><?php echo JText::_( 'Image, Pdf, CAD files' ); ?> <font color="#FF0000"><em><?php echo JText::_('(Please upload file less than 20Mb)')?></em></font></legend>
			<table class="admintable">
				...
				<tr>
					<td colspan="2" align="center"><a href="index.php?option=com_apdmpns&task=download&id=<?php echo $this->row->pns_id?>" title="Click here to download file"><?php echo $this->row->pns_pdf;?>&nbsp;(<?php $filesizepdf = CPNsController::Readfilesize('pdf', $this->row->pns_pdf); echo number_format($filesizepdf, 0, '.', ' ')?>&nbsp;KB)</a>&nbsp;&nbsp;					
