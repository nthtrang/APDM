						...
						<?php 
							if (count($this->lists['pns_parent_info']) > 0) {
								//foreach ($this->lists['pns_parent_info'] as $pns_parent) { 			
								 // $link_info = 'index.php?option=com_apdmcpns&task=detail&cid[0]='.$pns_parent['id'];
								?>
								<a class="modal-button" rel="{handler: 'iframe', size: {x: 650, y: 400}}" href="index.php?option=com_apdmcpns&task=list_child&tmpl=component&id=<?php echo $this->row->pns_id?>" title="Image">
					...
					<td valign="top">
						<?php 
							if (count($this->lists['where_use']) > 0) {								
								?>
								<a class="modal-button" rel="{handler: 'iframe', size: {x: 650, y: 400}}" href="index.php?option=com_apdmcpns&task=list_where_used&tmpl=component&id=<?php echo $this->row->pns_id?>" title="Image">
<input type="button" name="where_used" value="<?php echo JText::_('List PNs')?>"/>
                                                <a href="index.php?option=com_apdmcpns&task=list_where_used&tmpl=component&id=<?php echo $this->row->pns_id?>" title="Image">
<input type="button" name="where_used" value="<?php echo JText::_('List PNs')?>"/>
</a>
							<?php	
							}else{
				...
				<tr>
					...
					<td>
						<?php echo CPNsController::GetEcoValue($this->row->eco_id);?>
					</td>
				</tr>
				<tr>
					<td class="key" valign="top">
