...
function submitbutton(pressbutton) {
			...
			if (pressbutton == 'download') {
                                 window.location.assign("index.php?option=com_apdmcpns&task=download_cad_all_pns&pns_id=<?php echo $this->lists['pns_id']?>")
...
<div class="submenu-box">
	<div class="t">
		...
		<ul id="submenu" class="configuration">
			<li><a id="detail" href="index.php?option=com_apdmcpns&task=detail&cid[0]=<?php echo $this->lists['pns_id']?>"><?php echo JText::_( 'Detail' ); ?></a></li>
			<li><a id="bom"  class="active"><?php echo JText::_( 'BOM' ); ?></a></li>
			<li><a id="whereused" href="index.php?option=com_apdmcpns&task=whereused&id=<?php echo $this->lists['pns_id']?>"><?php echo JText::_( 'Where Used' ); ?></a></li>
                        <li><a id="specification" href="index.php?option=com_apdmcpns&task=specification&cid[]=<?php echo $this->lists['pns_id']?>"><?php echo JText::_( 'Specification' ); ?></a></li>
                        <li><a id="mep" href="index.php?option=com_apdmcpns&task=mep&cid[]=<?php echo $this->lists['pns_id'];?>"><?php echo JText::_( 'MEP' ); ?></a></li>
                        <li><a id="rev" href="index.php?option=com_apdmcpns&task=rev&cid[]=<?php echo $this->lists['pns_id'];?>"><?php echo JText::_( 'REV' ); ?></a></li>                        
		</ul>
		 <div class="clr"></div>
        </div>
        <div class="b">
...
<div class="clr"></div>
<p>&nbsp;</p>
<form action="index.php?option=com_apdmcpns" method="post" name="adminForm">
<?php 

$list_pns_id = CPNsController::DisplayPnsChildId($this->lists['pns_id'], $this->lists['pns_id']);

$new_pns = explode(",", $list_pns_id);
$list_pns = CPNsController::DisplayPnsAllChildId($this->lists['pns_id']);
?>
<div> <input type="checkbox" onclick="isChecked(this.checked);" value="<?php echo $this->lists['pns_id'];?>" name="cid[]"  /> Level 0&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?option=com_apdmcpns&task=detail&cid[]=<?php echo $this->lists['pns_id']?>&cd=<?php echo $this->lists['pns_id']?>" title="<?php echo JText::_('Click to see detail PNs')?>"> <strong><?php echo $pns_code_full?> </strong></a></a>
	...
	<thead>
        ...
        foreach ($list_pns as $row){
                $level++;
                $manufacture = CPNsController::GetManufacture($row->pns_id);
                ?>
        <tr>
                ...
                <td>1</td>
		<td width="45%"><?php echo '<p style="height:25px"><a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row->text.'</a></p> '; ?></td>		
        ...
        <?php
                //level2
               $list_pns_c = CPNsController::DisplayPnsAllChildId($row->pns_id); 
               if(isset($list_pns_c)&& sizeof($list_pns_c)>0)
               {
                       ...
                       ?>
                           <tr>
                                   <td><input  type="checkbox" id = "bom" onclick="isCheckedBom(this.checked,<?php echo $row->pns_id;?>);" value="<?php echo $row->pns_id;?>" name="cid[]"  /></td>
                                   <td>2</td>
                                <td width="45%"><?php echo '<p style="margin-left:40px"><a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row->text.'</a></p> '; ?></td>                                
                                <td><span class="editlinktip hasTip" title="<?php echo $row->pns_description; ?>" ><?php echo limit_text($row->pns_description, 15);?></span></td>
                                <td>
                                        <span style="display:block" id="text_find_number_<?php echo $row->pns_id;?>"><?php echo $row->pns_find_number;?></span>
                                        <input style="display:none" type="text" value="<?php echo $row->pns_find_number;?>" id="find_number_<?php echo $row->pns_id;?>"  name="find_number_<?php echo $row->pns_id;?>" />
                              ...
                              <?php
                                //level3
                               $list_pns_3 = CPNsController::DisplayPnsAllChildId($row->pns_id); 
                               if(isset($list_pns_3)&& sizeof($list_pns_3)>0)
                               {
                                        foreach ($list_pns_3 as $row3){
                                        $manufacture = CPNsController::GetManufacture($row3->pns_id);
                                       ?>
                                           <tr>
                                                   <td><input  type="checkbox" id = "bom" onclick="isCheckedBom(this.checked,<?php echo $row3->pns_id;?>);" value="<?php echo $row3->pns_id;?>" name="cid[]"  /></td>
                                                    <td>3</td>
                                                <td width="45%"><?php echo '<p style="margin-left:80px"><a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row3->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row3->text.'</a></p> '; ?></td>                                               
                                                <td>
                                               ...
                                               <?php
                                                //level4
                                               $list_pns_4 = CPNsController::DisplayPnsAllChildId($row3->pns_id); 
                                               if(isset($list_pns_4)&& sizeof($list_pns_4)>0)
                                               {
                                                        foreach ($list_pns_4 as $row4){
                                                                $manufacture = CPNsController::GetManufacture($row4->pns_id);
                                                       ?>
                                                           <tr>
                                                                   ...
                                                                   <td>4</td>
                                                                <td width="45%"><?php echo '<p style="margin-left:120px"><a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row4->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row4->text.'</a></p> '; ?></td>
                                                                ...
                                                                <td><?php echo $row4->pns_life_cycle;?></td>                                                                
                                                                        ...
                                                                        <?php
                                                                        //level5
                                                                       $list_pns_5 = CPNsController::DisplayPnsAllChildId($row4->pns_id); 
                                                                       if(isset($list_pns_5)&& sizeof($list_pns_5)>0)
                                                                       {
                                                                                foreach ($list_pns_5 as $row5){
                                                                                        $manufacture = CPNsController::GetManufacture($row5->pns_id);
                                                                               ?>
                                                                                   <tr>
                                                                                           ...
                                                                                           <td>5</td>
                                                                                        <td width="45%"><?php echo '<p style="margin-left:140px"><a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row5->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row5->text.'</a></p> '; ?></td>
                                                                                        ...
                                                                                        <td><?php echo $row5->pns_life_cycle;?></td>
                                                                                                ...
                                                                                                <?php
                                                                                                //level6
                                                                                               $list_pns_6 = CPNsController::DisplayPnsAllChildId($row5->pns_id); 
                                                                                               if(isset($list_pns_6)&& sizeof($list_pns_6)>0)
                                                                                               {
                                                                                                        foreach ($list_pns_6 as $row6){
                                                                                                                $manufacture = CPNsController::GetManufacture($row6->pns_id);
                                                                                                       ?>
                                                                                                           <tr>
                                                                                                                   ...
                                                                                                                   <td>6</td>
                                                                                                                <td width="45%"><?php echo '<p style="margin-left:180px"><a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row6->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row6->text.'</a></p> '; ?></td>
                                                                                                                ...
                                                                                                                <td><?php echo $row6->pns_life_cycle;?></td>
                                                                                                                 ...
                                                                                                                 <?php
                                                                                                                        //level7
                                                                                                                       $list_pns_7 = CPNsController::DisplayPnsAllChildId($row6->pns_id); 
                                                                                                                       if(isset($list_pns_7)&& sizeof($list_pns_7)>0)
                                                                                                                       {
                                                                                                                                foreach ($list_pns_7 as $row7){
                                                                                                                                        $manufacture = CPNsController::GetManufacture($row7->pns_id);
                                                                                                                               ?>
                                                                                                                                   <tr>
                                                                                                                                           ...
                                                                                                                                           <td>7</td>
                                                                                                                                        <td width="45%"><?php echo '<p style="margin-left:220px"><a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row7->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row7->text.'</a></p> '; ?></td>
                                                                                                                                       ...
                                                                                                                                       <td><?php echo $manufacture[0]['v_mf'];?></td>
                                                                                                                                        <td><?php echo $row7->pns_life_cycle;?></td>
                                                                                                                                                  ...
                                                                                                                                                  <?php
                                                                                                                                                //level8
                                                                                                                                               $list_pns_8 = CPNsController::DisplayPnsAllChildId($row7->pns_id); 
                                                                                                                                               if(isset($list_pns_8)&& sizeof($list_pns_8)>0)
                                                                                                                                               {
                                                                                                                                                        foreach ($list_pns_8 as $row8){
                                                                                                                                                                $manufacture = CPNsController::GetManufacture($row8->pns_id);
                                                                                                                                                       ?>
                                                                                                                                                           <tr>
                                                                                                                                                                   ...
                                                                                                                                                                   <td>8</td>
                                                                                                                                                                <td width="45%"><?php echo '<p style="margin-left:240px"> <a href="index.php?option=com_apdmcpns&task=detail&cid[]='.$row8->pns_id.'&cd='.$this->lists['pns_id'].'" title="'.JText::_('Click to see detail PNs').'">'.$row8->text.'</a></p> '; ?></td>
