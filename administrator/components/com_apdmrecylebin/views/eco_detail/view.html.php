 ...
 * @since 1.0
 */
class recylebinVieweco_detail extends JView
{
	function display($tpl = null)
	{
        ...
        $eco_status  = ($row->eco_id) ? $row->eco_status : 1;
		$lists['activate'] 	= JHTML::_('select.booleanlist',  'eco_status', 'class="inputbox" size="1"', $eco_status );
