...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1366 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td width=0 >PNs BOM MANAGEMENT</td>
  <td width=546 >&nbsp;</td>
  <td width=546 >&nbsp;</td>
  <td width=546 >&nbsp;</td>
  <td></td>
 ...
 <tr height=17 style='height:12.75pt'>
 	<td height=17 style='height:12.75pt'></td>
 	<td align="right" class="xl25" style='width:69pt'><div align="right">Date  :</div></td>
 ...
 <tr height=17 style='height:12.75pt'>
  <td height=17 style='height:12.75pt'></td>
  <td class=xl25><?php echo $pns_full_code;?></td>
  <td colspan=9 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 style='height:12.75pt'></td>
  <td class=xl25><font class="font0"> </font></td>
  <td colspan=9 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=19 style='mso-height-source:userset;height:14.25pt'>
  <td height=19 style='height:14.25pt'></td>
  <td class=xl30 width=546 style='width:69pt'><?php echo JText::_('Item'); ?></td>
  <td class=xl30 width=546 style='width:69pt'><?php echo JText::_('Level'); ?></td>
  <td class=xl30 width=546 style='width:176pt'><?php echo JText::_('Part BOM'); ?></td>
  <td class=xl31 width=546 style='width:100pt'><?php echo JText::_('ECO'); ?></td>
  <td class=xl31 width=546 style='width:100pt'><?php echo JText::_('Type'); ?></td>
  <td class=xl31 width=546 style='width:200pt'><?php echo JText::_('Status'); ?></td>
   <td class=xl32 width=546 style='width:300pt'><?php echo JText::_('Description'); ?></td>
 </tr>
 <?php  //for content  
   echo $str;
 ?>
