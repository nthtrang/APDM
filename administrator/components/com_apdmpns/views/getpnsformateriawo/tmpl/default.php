...
<form action="index.php?option=com_apdmpns&task=get_list_pns_material&tmpl=component&wo_id=<?php echo $wo_id?>" method="post" name="adminForm" id="adminFormPns"  >
		...
		<tr>
			...
			<td align="right"><?php
                      //  if($this->pns_status!='Release')
                       /// {
                                ?><input type="button" name="btinsert" value="Save" onclick="UpdatePnsMaterialWo();" /> 
                        <?php
                     //   }
                        ?>
                        </td>	
