...
<form action="index.php?option=com_apdmpns&task=saveonholdwo&tmpl=component&id=<?php echo $so_id?>" method="post" name="adminForm" enctype="multipart/form-data" >      
        ...
        <input type="hidden" name="task" value="saveonholdwo" />	
