...
function saveCommentResumeWoStep(){
       ...
       if (form.passwd.value==""){
		...
		var url = 'index.php?option=com_apdmpns&task=saveResumeStepWo&id='+wo_id;                
...
<form action="index.php?option=com_apdmpns&task=saveResumeStepWo&tmpl=component&id=<?php echo $wo_id?>" method="post" id="adminForm" name="adminForm" enctype="multipart/form-data" >      
        <fieldset class="adminform">
			...
			<td <td colspan="3" align="center">                                
                                <input type="button" name="btinsersavecomment" value="Ok"  onclick="saveCommentResumeWoStep();"/>                        
        ...
        <input type="hidden" name="task" value="saveResumeStepWo " />	
