...
<form action="index.php?option=com_apdmpns&task=savecancelwopop&tmpl=component&id=<?php echo $so_id?>" method="post" name="adminForm" enctype="multipart/form-data" >      
                ...
                <div class="col width-100">
                        <fieldset class="adminform">		
                                <table class="admintable" cellspacing="1" width="100%">
                                        <tr>
			<td></td>
			<td align="right"><input type="button" name="btinsersave" value="Save"  onclick="onHoldWo();UpdatePnsRevWindow();"/>
        ...
        <input type="hidden" name="task" value="savecancelwopop" />	
