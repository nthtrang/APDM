...
<form action="index.php?option=com_apdmpns&task=saveCompeteStepWo&tmpl=component&id=<?php echo $wo_id?>" method="post" id="adminForm" name="adminForm" enctype="multipart/form-data" >      
        <fieldset class="adminform">
                ...
                <div class="col width-100">
                        <fieldset class="adminform">	
                                ...
                                <table class="admintable" cellspacing="1" width="100%">
                                        ...
                                        <tr>
                                                <td colspan="3">
                                                        <textarea name="op_comment" rows="10" cols="70"></textarea>
                                                </td>
                 ...
                 <tr>
					...
					<td colspan="2">
						<input name="username" type="text" readonly="readonly" id="modlgn_username" value="<?php echo $me->get('username')?>" type="text" class="inputbox" size="15" />                                                
					</td>
				</tr>
                 <tr>
					<td class="key">
			...
			<td <td colspan="3" align="center"><input type="button" name="btinsersave" value="Save"  onclick="onCompleteWo();UpdateCompleteWo();"/>
<input type="button" name="btinsersave" value="Cancel"  onclick="onCompleteWo();UpdateCompleteWo();"/>                        
                        </td>	
		</tr>	
                                </table>
        ...
        <input type="text" name="wo_id" value="<?php echo $wo_id; ?>" />
        <input type="text" name="so_id" value="<?php echo $so_id; ?>" />
        <input type="text" name="wo_step" value="<?php echo $step; ?>" />
        <input type="text" name="wo_assigner" value="<?php echo $assignee; ?>" />
