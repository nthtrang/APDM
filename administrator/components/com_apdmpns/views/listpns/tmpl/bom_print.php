            ...
            foreach ($list_pns as $row){
                ...
                if(isset($list_pns_c)&& sizeof($list_pns_c)>0)
                {
                    foreach ($list_pns_c as $row2){
                        ...
                        <tr>
                            <td align="center" style="border-left:0px;border-right:0px"><?php echo $step;?></td>
                            <td align="center" style="border-left:0px;border-right:0px">2</td>
                            <td  align="center" width="25%" style="border-left:0px;border-right:0px"><?php
                                ...
                                ?></td>
                            <td align="left"  style="text-align: left !important;border-left:0px;border-right: 0px;"><?php echo limit_text($row2->pns_description, 15);?></td>
                            <td align="center" style="border-left:0px;border-right:0px">
                            ...
                            <td align="center" style="border-left:0px;border-right:0px"><?php echo $row2->pns_uom;?></td>
                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['mf'];?></td>
                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['v_mf'];?></td>
                            <td align="left" style="border-left:0px;border-right:0px"><?php
                                // $ToolPN = GetToolPnValue($row->pns_id);
                        ...
                        if(isset($list_pns_3)&& sizeof($list_pns_3)>0)
                        {
                            foreach ($list_pns_3 as $row3){
                                ...
                                <tr>
                                    <td align="center" style="border-left:0px;border-right:0px"><?php echo $step;?></td>
                                    <td align="center" style="border-left:0px;border-right:0px">3</td>
                                    <td align="center"  width="25%" style="border-left:0px;border-right:0px"><?php
                                        ...
                                        ?></td>
                                    <td align="left" style="text-align: left !important;border-left:0px;border-right: 0px" width="15%"><?php echo limit_text($row3->pns_description, 15);?></td>
                                    <td align="center" style="border-left:0px;border-right:0px">
                                    ...
                                    <td align="center" style="border-left:0px;border-right:0px"><?php echo $row3->pns_uom;?></td>
                                    <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['mf'];?></td>
                                    <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['v_mf'];?></td>
                                    <td align="left" style="border-left:0px;border-right:0px"><?php
                                        // $ToolPN = GetToolPnValue($row->pns_id);
                                ...
                                if(isset($list_pns_4)&& sizeof($list_pns_4)>0)
                                {
                                    foreach ($list_pns_4 as $row4){
                                        ...
                                        <tr>
                                            <td align="center" style="border-left:0px;border-right:0px"><?php echo $step;?></td>
                                            <td align="center" style="border-left:0px;border-right:0px">4</td>
                                            <td align="center" width="25%" style="border-left:0px;border-right:0px"><?php
                                                ...
                                                ?></td>
                                            <td  align="left" align="left" style="text-align: left !important;border-left:0px;border-right: 0px;" width="15%"><?php echo limit_text($row4->pns_description, 15);?></td>
                                            <td align="center" style="border-left:0px;border-right:0px">
                                            ...
                                            <td align="center" style="border-left:0px;border-right:0px"><?php echo $row4->pns_uom;?></td>
                                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['mf'];?></td>
                                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['v_mf'];?></td>
                                            <td align="left" style="border-left:0px;border-right:0px" ><?php
                                                // $ToolPN = GetToolPnValue($row->pns_id);
                                        ...
                                        if(isset($list_pns_5)&& sizeof($list_pns_5)>0)
                                        {
                                            foreach ($list_pns_5 as $row5){
                                                ...
                                                <tr>
                                                    <td align="center" style="border-left:0px;border-right:0px"><?php echo $step;?></td>
                                                    <td align="center" style="border-left:0px;border-right:0px">5</td>
                                                    <td align="center" width="25%" style="border-left:0px;border-right:0px"><?php
                                                        ...
                                                        ?></td>
                                                    <td align="left" style="text-align: left !important;border-left:0px;border-right: 0px;" width="15%"><?php echo limit_text($row5->pns_description, 15);?></td>
                                                    <td align="center" style="border-left:0px;border-right:0px">
                                                    ...
                                                    <td align="center" style="border-left:0px;border-right:0px"><?php echo $row5->pns_uom;?></td>
                                                    <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['mf'];?></td>
                                                    <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['v_mf'];?></td>
                                                    <td align="left" style="border-left:0px;border-right:0px"><?php
                                                        // $ToolPN = GetToolPnValue($row->pns_id);
                                                ...
                                                if(isset($list_pns_6)&& sizeof($list_pns_6)>0)
                                                {
                                                    foreach ($list_pns_6 as $row6){
                                                        ...
                                                        <tr>
                                                            <td align="center" style="border-left:0px;border-right:0px"><?php echo $step;?></td>
                                                            <td align="center" style="border-left:0px;border-right:0px">6</td>
                                                            <td  align="center" width="25%" style="border-left:0px;border-right:0px"><?php
                                                                ...
                                                                ?></td>
                                                            <td  align="left" style="text-align: left !important;border-left:0px;border-right: 0px;" width="15%"><?php echo limit_text($row6->pns_description, 15);?></td>
                                                            <td align="center" style="border-left:0px;border-right:0px">
                                                            ...
                                                            <td align="center" style="border-left:0px;border-right:0px"><?php echo $row6->pns_uom;?></td>
                                                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['mf'];?></td>
                                                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['v_mf'];?></td>
                                                            <td align="left" style="border-left:0px;border-right:0px"><?php
                                                                // $ToolPN = GetToolPnValue($row->pns_id);
                                                        ...
                                                        if(isset($list_pns_7)&& sizeof($list_pns_7)>0)
                                                        {
                                                            foreach ($list_pns_7 as $row7){
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="border-left:0px;border-right:0px"><?php echo $step;?></td>
                                                                    <td align="center" style="border-left:0px;border-right:0px">7</td>
                                                                    <td align="center"  width="25%" style="border-left:0px;border-right:0px"><?php
                                                                        ...
                                                                        ?></td>
                                                                    <td align="left"  style="text-align: left !important;border-left:0px;border-right: 0px" width="15%"><?php echo limit_text($row7->pns_description, 15);?></td>
                                                                    <td align="center" style="border-left:0px;border-right:0px">
                                                                    ...
                                                                    <td align="center" style="border-left:0px;border-right:0px"><?php echo $row7->pns_uom;?></td>
                                                                    <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['mf'];?></td>
                                                                    <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['v_mf'];?></td>
                                                                    <td align="left" style="border-left:0px;border-right:0px"><?php
                                                                        // $ToolPN = GetToolPnValue($row->pns_id);
                                                                ...
                                                                if(isset($list_pns_8)&& sizeof($list_pns_8)>0)
                                                                {
                                                                    foreach ($list_pns_8 as $row8){
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" style="border-left:0px;border-right:0px"><?php echo $step;?></td>
                                                                            <td align="center" style="border-left:0px;border-right:0px">8</td>
                                                                            <td align="center"  width="25%" style="border-left:0px;border-right:0px"><?php
                                                                                ...
                                                                                ?></td>
                                                                            <td align="left"  style="text-align: left !important;border-left:0px;border-right: 0px;" width="15%"><?php echo limit_text($row8->pns_description, 15);?></td>
                                                                            <td align="center" style="border-left:0px;border-right:0px">
                                                                            ...
                                                                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $row8->pns_uom;?></td>
                                                                            <td align="left" style="border-left:0px;border-right:0px"><?php echo $manufacture[0]['mf'];?></td>
