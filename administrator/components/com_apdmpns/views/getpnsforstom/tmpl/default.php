...
function UpdatePnsEco(){        
	...
	if ($('boxchecked').value==0){
		...
		var url = 'index.php?option=com_apdmpns&task=ajax_add_pns_stos_movelocation&sto_id='+sto_id;
...
<form action="index.php?option=com_apdmpns&task=get_list_pns_sto_movelocation&tmpl=component&sto_id=<?php echo $sto_id?>" method="post" name="adminForm" id="adminFormPns"  >
