...
function get_default_ito_prefix(){		
		var url = 'index.php?option=com_apdmpns&task=iesto_prefix_default&sto_type=1';				
...
<form action="index.php?option=com_apdmpns&task=save_stoi&time=<?php echo time();?>" method="post" name="adminFormPnsrev" enctype="multipart/form-data" >
         <table  width="100%">
		<tr>
			<td></td>
			...
			<table class="admintable" cellspacing="1">
					...
					<td>
						<input type="text" readonly="readonly" name="sto_code" id="sto_code"  size="10" value="I<?php echo $this->sto_row->sto_code?$this->sto_row->sto_code:date('ymd');?>"/>
