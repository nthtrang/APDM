...
<div class="submenu-box">
		...
		<ul id="submenu" class="configuration">
			...
			<li><a id="bom" href="index.php?option=com_apdmpns&task=bom&id=<?php echo $this->id;?>"><?php echo JText::_( 'BOM' ); ?></a></li>
                        <li><a id="ecohistory" href="index.php?option=com_apdmpns&task=eco_history&cid[0]=<?php echo $this->id;?>"><?php echo JText::_( 'ECO Released History' ); ?></a></li>
			<li><a id="whereused" class="active"><?php echo JText::_( 'Where Used' ); ?></a></li>
                        ...
                        <?php } ?>
                        <li><a  id="dash" href="index.php?option=com_apdmpns&task=po&cid[]=<?php echo $this->id;?>"><?php echo JText::_( 'PO' ); ?></a></li>                        
