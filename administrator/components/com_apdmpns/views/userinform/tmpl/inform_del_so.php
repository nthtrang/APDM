...
function UpdateDeleteSo(){
		...
		var url = 'index.php?option=com_apdmpns&task=ajax_deleteso&id='+so_id;                
		var MyAjax = new Ajax(url, {
			...
			onComplete:function(result){                                
                                ...
                                {                                    
                                        ...
                                        window.parent.location = "index.php?option=com_apdmpns&task=somanagement";
                                }
		 ...
		 <tr>
					...
					<td>
						<input name="username" type="hidden" id="modlgn_username" value="<?php echo $me->get('username')?>" type="text" class="inputbox" size="15" />
                           ...
                           <tr>
			<td></td>
			<td align="right"><input type="button" name="btinsersave" value="Save"  onclick="UpdateDeleteSo();"/>
