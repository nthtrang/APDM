...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1366 style='border-collapse:
 ...
 $i=1;  
 foreach($rows as $row){ 
	 $arr_parent = PNsController::GetArrPartNumberParent($row->pns_id);
	 $arr_mf = PNsController::GetArrInfo($row->pns_id, 4);
	 $arr_vendor = PNsController::GetArrInfo($row->pns_id, 2);
	 $arr_supplier = PNsController::GetArrInfo($row->pns_id, 3);
 ?>
 <tr height=34 style='height:25.5pt'>
  ...
  <td class=xl34 width=546 style='width:100pt' x:str="<?php echo PNsController::GetECO($row->eco_id);?>"><?php echo PNsController::GetECO($row->eco_id);?></td>
