...
class  TToViewgetwo extends JView
{
	function display($tpl = null)
	{
        ...
        $query = 'SELECT count(*)'
            . ' from apdm_pns_wo wo'
            . ' left join apdm_pns_so so on so.pns_so_id=wo.so_id left join apdm_ccs ccs on so.customer_id = ccs.ccs_code '
		...
		$query = 'SELECT wo.pns_wo_id,wo.wo_code, so.so_cuscode,so.customer_id as ccs_so_code,ccs.ccs_coordinator,ccs.ccs_name,ccs.ccs_code '
			. ' from apdm_pns_wo wo'
            . ' left join apdm_pns_so so on so.pns_so_id=wo.so_id left join apdm_ccs ccs on so.customer_id = ccs.ccs_code '
			. $where			
			. $orderby
